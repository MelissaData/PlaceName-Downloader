...
- Melissa Place Name for 2026-01
...
```
$ git clone https://github.com/MelissaData/PlaceName-Downloader.git
$ cd PlaceName-Downloader
```
...
You will need to set your license before running the `PlaceName_Downloader.ps1`. 
...
You will need to set your license before running the `PlaceName_Downloader.sh`. 
